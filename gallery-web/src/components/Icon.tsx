...
export type IconName =
  ...
  | 'palette' | 'clients' | 'help' | 'logo'
  | 'photo' | 'download' | 'heart' | 'mail' | 'calendar'
  | 'copy' | 'duplicate' | 'trash' | 'check' | 'close' | 'plus'
  | 'star' | 'star-filled' | 'shield' | 'bolt' | 'face-search'
  | 'search' | 'menu' | 'arrow-out' | 'logout' | 'token'
...
const PATHS: Record<IconName, string> = {
  ...
  sections:   '<rect x="3" y="3" width="7" height="9" rx="1"/><rect x="14" y="3" width="7" height="5" rx="1"/><rect x="14" y="12" width="7" height="9" rx="1"/><rect x="3" y="16" width="7" height="5" rx="1"/>',
  stories:    '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/><polygon points="10 8 15 11 10 14" fill="currentColor" stroke="none"/>',
  ...
  logo:       '<rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 16-5-5L5 21"/>',
  ...
  'face-search': '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/><path d="M8 11h.01"/><path d="M14 11h.01"/><path d="M9 14a3 3 0 0 0 4 0"/>',
  search:     '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',
  menu:       '<line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/>',
  'arrow-out':'<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>',
  logout:     '<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>',
  token:      '<circle cx="12" cy="12" r="9"/><path d="M12 7v10M9 9h4.5a2.5 2.5 0 0 1 0 5H9m0 0h5"/>',
}
