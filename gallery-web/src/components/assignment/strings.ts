...
const he = {
  ...
  'assign.field.placeholder': 'בחרו לקוח…',
  'assign.field.search': 'חיפוש לקוח…',
  'assign.field.noResults': 'לא נמצאו לקוחות תואמים.',
  'assign.field.createNew': 'יצירת לקוח חדש',
  'assign.field.createName': 'שם הלקוח',
  'assign.field.createSubmit': 'יצירה ובחירה',
  ...
  'bulk.subtitle': 'שייכו גלריות ללקוחות כדי שיופיעו באזור האישי שלהם. אפשר לסמן כמה גלריות ולשייך את כולן בפעולה אחת.',
  ...
  'bulk.empty.body': 'צרו גלריות במסך "הגלריות שלי" כדי לשייך אותן ללקוחות.',
  'bulk.noResults.title': 'אין תוצאות',
  'bulk.noResults.body': 'לא נמצאו גלריות התואמות את החיפוש או הסינון.',
  'bulk.selectAll': 'בחירת כל המוצגות',
  'bulk.clearSelection': 'ניקוי הבחירה',
  'bulk.selectedCount': 'גלריות נבחרו',
  'bulk.assignSelected': 'שיוך הנבחרות',
  'bulk.assignedTo': 'משויכת ל־',
  ...
  'bulk.hidden.noActiveMembers': 'אף לקוח לא רואה את הגלריה: הלקוח עדיין לא אישר את ההזמנה',
  'bulk.hiddenBadge': 'לא גלוי ללקוח',
  'bulk.assign': 'שיוך ללקוח',
  'bulk.reassign': 'שיוך מחדש',
  'bulk.unassign': 'ביטול שיוך',
  ...
  'bulk.modal.submitAssign': 'שיוך',
  'bulk.modal.submitReassign': 'שיוך מחדש',
  ...
  'bulk.confirm.reassignOk': 'שיוך מחדש',
  ...
  'bulk.confirm.unassignOk': 'ביטול שיוך',
  ...
  'bulk.confirm.bulkOk': 'שיוך כל הנבחרות',
  ...
  'bulk.tooMany': 'ניתן לשייך עד 200 גלריות בפעולה אחת. צמצמו את הבחירה.',
...
const en: Record<AssignmentStringKey, string> = {
  ...
  'bulk.hidden.noActiveMembers': 'No client can see this gallery: the client has not accepted the invitation yet',
