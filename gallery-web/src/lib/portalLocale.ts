...
const STRINGS = {
  he: {
    ...
    'gate.restricted.body': 'אזור הלקוח דורש חשבון גישה. פנו לצלם כדי לקבל הזמנה.',
  ...
  en: {
    ...
    'gate.restricted.body': 'This client area requires an access account. Contact your photographer for an invitation.',
