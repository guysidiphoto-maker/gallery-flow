...
const STATIC_ROUTES: SeoRoute[] = [
  ...
  },
  {
    ...
    lang: 'he',
    dir: 'rtl',
    title: 'גלריות אירועים יפות ויעילות עם זיהוי פנים | Pixflow',
    description:
      'גלריות אירועים ממותגות ומוקפדות עם זיהוי פנים, שבהן כל אורח מוצא את עצמו בשניות עם סלפי. יפה ללקוח, פשוט לכם, בלי אפליקציה לאורחים.',
